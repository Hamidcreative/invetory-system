...
<head>
    ...
    <title>500 Page | Materialize - Material Design Admin Template</title>
    ...
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/css/pages/page-500.css">
    <!-- END: Page Level CSS-->
    <!-- BEGIN: Custom CSS-->
...
<!-- END: Head-->
<body class="vertical-layout page-header-light vertical-menu-collapsible vertical-dark-menu 1-column   blank-page blank-page" data-open="click" data-menu="vertical-dark-menu" data-col="1-column">
<div class="row">
    <div class="col s12">
        <div class="container"><div class="section p-0 m-0 height-100vh section-500">
                <div class="row">
                    ...
                    <div class="col s12 center-align white">
                        <img src="<?=base_url()?>assets/images/gallery/error-2.png" alt="" class="bg-image-500">
                        <h1 class="error-code m-0">404</h1>
                        <h6 class="mb-2">BAD REQUEST Record not found</h6>
                        <a class="btn waves-effect waves-light gradient-45deg-deep-purple-blue gradient-shadow mb-4" href="<?=base_url('')?>">Back
                            TO Home</a>
                    </div>
                </div>
            </div>
