                        ...
                        <div class="col s12 m12 l12">
                            <div id="Form-advance" class="card card card-default scrollspy">
                                <div class="card-content">
                                    <form class="col s12" method="POST" action="<?=base_url('warehouse/add')?>">
                                        <input type="hidden" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" />
                                        <div class="row">
                                            <div class="input-field col m6 s12">
                                                <input id="first_name01" name="name" type="text" <?=set_value('name')?>>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <textarea name="descrption" class="materialize-textarea"> <?=set_value('descrption')?> </textarea>
