            ...
            <div class="container">
                <div class="row">
                    <div class="col s12 m6 l6">
                        <h5 class="breadcrumbs-title mt-0 mb-0">Send To Technician</h5>
                    </div>
                    <div class="col s12 m6 l6 right-align-md">
                        <ol class="breadcrumbs mb-0">
                            <li class="breadcrumb-item"><a href="<?= base_url('dashboard')?>">Home</a></li>
                            <li class="breadcrumb-item"><a href="#">Send To Technician</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="section">
                    <div class="card">
                        <div class="card-content">
                            <table>
                                <tr>
                                    <td colspan="2">Warehouse issues Spare parts to the End user (Technician) </td>
                                </tr>
                                <tr>
                                    <td>Item code:- </td>
                                ...
                                <tr>
                                    ...
                                    <td>Issued to end user (technician name) </td>
                                </tr>
                                <tr>
                                    <td>Amount:-</td>
                                ...
                                <tr>
                                    ...
                                    <td>Selct the name of the warehouse which Issued the spare part</td>
                                </tr>
                                <tr>
                                    <td> Scan Button:- </td>
